// script form to googlesheet
    const scriptURL = 'https://script.google.com/macros/s/AKfycbzAlnr0Yu6CiK5XJZwtGQeYCsYviO5-pwgMB7dxDglg9-volsXUCLApw1BtE8EB55vffg/exec'
    const form = document.forms['cashflow-cikajang'];
