// script form to googlesheet
    const scriptURL = 'https://script.google.com/macros/s/AKfycbzH-_Apc8kQiTLFqe5dI3DCeYyvi-IZRK3DPjlnwREmHM-aigWf0VqimgPsuHqgZsHn/exec'
    const form = document.forms['cashflow-pangatikan'];
