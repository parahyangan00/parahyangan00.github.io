// script form to googlesheet
    const scriptURL = 'https://script.google.com/macros/s/AKfycbxU5u5ODbemFBBXQd8sYkyEuzIdp73xBsPaYUEuMvCBUkKxs2HF7lAJTeo-txW7IDRP/exec'
    const form = document.forms['cashflow-pasirwangi'];
